...
interface LatencyStatsQueryResult {
  id: string;
  url: string;
  lastSets: LatencySetResult[];
...
async function fetchWorkflowStats(workflowId: string): Promise<LatencyStatsQueryResult | null> {
  try {
